    ...
    <div class="container mx-4 md:mx-20">
      ...
      <div class=" flex flex-wrap py-16 text-center">
       <div class="wrapper">
        ...
        <p class="text-gray-500 text-[12px]">choose your desired pickup and drop-off from wide range of locations to suit your needs</p>
       </div>
       <div class="w-1/5 ps-2 hidden lg:block">
         <img src="../assets/home-images/icons/vecteezy_hand-drawn-dotted-arrow-line-clip-art_22185823 2.png" alt="">
       </div>
       ...
       <div class="wrapper">
        ...
        <p class="text-gray-500 text-[12px]">Select your preferred pickup and drop-off dates and times to find the best availability and rates.</p>
       </div>
       <div class="w-1/5 ps-2 hidden lg:block">
         <img src="../assets/home-images/icons/vecteezy_hand-drawn-dotted-arrow-line-clip-art_22185823 2.png" alt="">
       </div>
   ...
   <section class="bg-bg_color pt-0 pb-24 my-0 text-center">
    <div class="container mx-4 md:mx-20">
      ...
      <div class="flex flex-wrap">
        <div class="mx-1 w-full md:w-1/2 lg:w-1/3 my-2">
          <CarCard></CarCard>
        </div>
          ...
          <div class="flex w-full lg:w-1/2 flex-wrap">
            <div class="w-1/2 p-1">
              <div class="py-6 px-4 bg-white hover:bg-blue-50 rounded-2xl custom-shadow">
                ...
                <p class="text-gray-500 text-[12px]">With a vast fleet of vehicles, we offer the perfect car for every preference.</p>
              </div>
            </div>
            ...
            <div class="w-1/2 p-1">
              <div class="py-6 px-4 bg-white hover:bg-blue-50 rounded-2xl custom-shadow">
                ...
                <p class="text-gray-500 text-[12px]"> We have convenient pickup and drop-off locations to suit your travel needs.</p>
              </div>
            </div>

            <div class="w-1/2 p-1">
              <div class="py-6 px-4 bg-white hover:bg-blue-50 rounded-2xl custom-shadow">
                <h3 class="text-[22px] font-medium mb-2">Flexible Rental Options</h3>
                <p class="text-gray-500 text-[12px]"> Need a car for a few hours, a day, or longer, we offer flexible rental options.</p>
              </div>
            </div>
          </div>
