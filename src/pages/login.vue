<template>
  ...
  <div v-if="isModalOpen" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
    <div class="flex custom-shadow m-4 lg:h-[680px] rounded-2xl mx-auto lg:w-[1064px] w-[364px] h-[464px] bg-white ">
      ...
      <div v-if="signup && !OwnerorUser && role == 'user'" class="signUp lg:w-6/12 w-full p-4 ">
        ...
        <div class="lg:ml-9 mx-auto flex flex-col gap-3">
          <div class="flex gap-2 items-center py-1">
            <label class="">
              <input type="checkbox" class="accent-gray-900" id="sedan" value="sedan" required />
      ...
      <div v-if="!signup && !OwnerorUser" class="login lg:w-6/12 w-full px-4 lg:pt-24 lg:py-12 py-6">
