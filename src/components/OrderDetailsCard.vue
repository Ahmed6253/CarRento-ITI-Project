  ...
  >
    ...
    <section class="px-8 py-0 w-full md:w-1/2 lg:w-full mt-4">
      ...
      <div class="flex justify-between mb-6">
        <section>
          <p class="text-xl">Pick-up location</p>
          <p class="text-Paragraph_color text-[16px] text-start">
            {{ location }}
          </p>
        </section>
        <button class="w-6" @click="$router.push('/cars')">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <div class="flex justify-between mb-6">
        <section>
          <p class="text-xl">Pick-up date</p>
          <p class="text-Paragraph_color text-[16px] text-start">
            {{ pickUpDate }}
          </p>
        </section>
      ...
      <div class="flex justify-between mb-6">
        <section>
          <p class="text-xl">Drop-off date</p>
          <p class="text-Paragraph_color text-[16px] text-start">
            {{ dropOffDate }}
          </p>
        </section>
      ...
      >
        ...
        <button class="w-6" @click="$router.go(-1)">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
...
export default {
  props: ["imgUrl", "pickUpDate", "dropOffDate", "location"],
