<template>
  <div class="car-sum-comp custom-shadow flex flex-col-reverse md:flex-row lg:flex-col items-center p-4 w-full">
    <section class="w-full md:w-1/2 lg:w-full p-0 ">
      <img :src="url" alt="car image" class="rounded-lg border border-border_color custom-shadow">
    </section>
    <section class="px-8 py-0 w-full md:w-1/2 lg:w-full mt-4">
      ...
      <div class="flex justify-between mb-6">
        ...
        <button class="w-6">
          <img src="../assets/home-images/icons/edit.svg" alt="" class="w-full" @click="$router.push('/cars')">
        </button>
      </div>
      ...
      <div class="flex justify-between mb-6">
        ...
        <button class="w-6">
          <img src="../assets/home-images/icons/edit.svg" alt="" class="w-full"
