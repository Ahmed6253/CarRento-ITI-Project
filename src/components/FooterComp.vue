<template>
  <!-- footer start -->
  <div class="bg-footer text-slate-50">
    <div class="mx-4 md:mx-20">
      <!-- section one  -->
      <div
        class="flex justify-between flex-col md:flex-row items-center border-b-[1px] py-6 border-slate-50"
      >
        ...
        <div
          class="gap-4 flex flex-col sm:flex-row pt-3 md:pt-0 w-full md:w-auto"
        >
          <input
            type="text"
      ...
      <!-- section two -->
      <div
        class="flex flex-col md:flex-row justify-between border-b-[1px] py-6 border-slate-50"
      >
        <!-- first colum -->
        ...
        <div class="flex flex-col gap-y-4 w-full md:w-2/12 py-3 md:py-0">
          ...
          <p class="text-xs">
            <a
              class="flex"
              href="https://maps.app.goo.gl/xENjCAT8guw1yiYu6"
              target="”_blank”"
              ><svg
                width="20"
                class="mr-2"
      ...
      <div class="flex gap-2 flex-col md:flex-row w-full justify-center py-4">
